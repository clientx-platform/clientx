...
class Integrations::Facebook::MessageCreator
  ...
  def perform
    ...
    # rescue => e
    # ClientxExceptionTracker.new(e).capture_exception
    # end
  end
  ...
  def agent_message_via_echo?
    # TODO : check and remove send_from_clientx_app if not working
    response.echo? && !response.sent_from_clientx_app?
    # this means that it is an agent message from page, but not sent from clientx.
