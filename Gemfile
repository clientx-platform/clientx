...
gem 'azure-storage-blob', git: 'https://github.com/clientx-platform/azure-storage-ruby', branch: 'main', require: false
...
gem 'devise'
gem 'devise-secure_password', git: 'https://github.com/clientx-platform/devise-secure_password', branch: 'main'
...
gem 'twitty', git: 'https://github.com/clientx-platform/twitty', branch: 'main'
# facebook client
gem 'koala'
# slack client
...
gem 'html2text', git: 'https://github.com/clientx-platform/html2text_ruby', branch: 'main'
