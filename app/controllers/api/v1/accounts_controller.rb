class Api::V1::AccountsController < Api::BaseController
  ...
  def show
    @latest_clientx_version = ::Redis::Alfred.get(::Redis::Alfred::LATEST_CLIENTX_VERSION)
  ...
  def validate_captcha
    raise ActionController::InvalidAuthenticityToken, 'Invalid Captcha' unless ClientxCaptcha.new(params[:h_captcha_client_response]).valid?
  end
