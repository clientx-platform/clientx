...
class AccountDashboard < Administrate::BaseDashboard
  ...
  enterprise_attribute_types = if ClientxApp.enterprise?
                                 {
  ...
  enterprise_show_page_attributes = ClientxApp.enterprise? ? %i[limits all_features] : []
  ...
  enterprise_form_attributes = ClientxApp.enterprise? ? %i[limits all_features] : []
  FORM_ATTRIBUTES = (%i[
    name
    locale
    status
