    ...
    <form v-if="!uiFlags.isFetchingItem" @submit.prevent="updateAccount">
      ...
      <div class="text-sm text-center p-4">
        ...
        <div v-if="hasAnUpdateAvailable && globalConfig.displayManifest">
          {{
            $t('GENERAL_SETTINGS.UPDATE_CLIENTX', {
              latestClientxVersion: latestClientxVersion,
            })
          }}
        </div>
        <div class="build-id">
...
export default {
  ...
  computed: {
    ...
    hasAnUpdateAvailable() {
      if (!semver.valid(this.latestClientxVersion)) {
        return false;
      }
    ...
    async initializeAccount() {
      try {
        ...
        const {
          ...
          latest_clientx_version: latestClientxVersion,
        ...
        this.latestClientxVersion = latestClientxVersion;
      } catch (error) {
        // Ignore error
      }
    },
