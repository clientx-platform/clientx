  ...
  computed: {
    ...
    termsLink() {
      return this.$t('REGISTER.TERMS_ACCEPT')
        .replace('https://www.clientx.io/terms', this.globalConfig.termsURL)
        .replace(
          'https://www.clientx.io/privacy-policy',
    ...
    showGoogleOAuth() {
      return Boolean(window.clientx.onfig.googleOAuthClientId);
    },
  },
  methods: {
    async submit() {
