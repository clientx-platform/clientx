...
describe('nextAvailabilityTimeMixin', () => {
  ...
  beforeAll(() => {
    window.clientx.ebChannel = clientx.ebChannel;
  });

  afterAll(() => {
    delete window.clientx.ebChannel;
  });
  ...
  it('should return channelConfig', () => {
    ...
    const vm = new Constructor().$mount();
    const wrapper = createWrapper(vm);
    expect(wrapper.vm.channelConfig).toEqual(clientx.ebChannel);
  });
  ...
  it('should return workingHours', () => {
    ...
    const vm = new Constructor().$mount();
    const wrapper = createWrapper(vm);
    expect(wrapper.vm.workingHours).toEqual(clientx.ebChannel.workingHours);
  });
  ...
  it('should return currentDayWorkingHours', () => {
    ...
    const expectedWorkingHours = clientx.ebChannel.workingHours.find(
  ...
  it('should return hoursAndMinutesBackInOnline', () => {
    ...
    const currentDayCloseHour =
      clientx.ebChannel.workingHours[wrapper.vm.currentDay].close_hour;
    const nextDayOpenHour =
      clientx.ebChannel.workingHours[
  ...
  it('should return in 30 minutes', () => {
    ...
    clientx.ebChannel.workingHours[4].open_hour = 18;
    clientx.ebChannel.workingHours[4].open_minutes = 0;
    clientx.ebChannel.workingHours[4].close_hour = 23;
  ...
  it('should return in 3 hours', () => {
    ...
    clientx.ebChannel.workingHours[4].open_hour = 19;
  ...
  it('should return at 10:00 AM', () => {
    ...
    clientx.ebChannel.workingHours[4].open_hour = 10;
  ...
  it('should return tomorrow', () => {
    ...
    clientx.ebChannel.workingHours[4].open_hour = 9;
    clientx.ebChannel.workingHours[4].close_hour = 16;
  ...
  it('should return on Saturday', () => {
    ...
    clientx.ebChannel.workingHours[4].open_hour = 9;
    clientx.ebChannel.workingHours[4].close_hour = 16;
    clientx.ebChannel.workingHours[5].closed_all_day = true;
